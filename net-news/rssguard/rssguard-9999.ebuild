...
EGIT_REPO_URI="https://github.com/martinrotter/rssguard/"
EGIT_BRANCH="master"
inherit cmake optfeature xdg git-r3 go-module
...
src_unpack() {
	git-r3_src_unpack
	cd "${P}/resources/scripts/standalone/article-extractor" || die
	# go-module_live_vendor
	ego mod download -modcacherw
}

src_configure() {
	go-env_set_compiler-environment
	local mycmakeargs=(
		-DBUILD_WITH_QT6=ON
